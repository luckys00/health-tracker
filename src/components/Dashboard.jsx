...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      {/* Welcome Header */}
      <div className="bg-gradient-to-r from-violet-600 via-indigo-600 to-cyan-500 rounded-3xl p-6 sm:p-8 text-white shadow-xl shadow-indigo-100 dark:shadow-none flex flex-col md:flex-row md:items-center justify-between gap-6 transition-colors">
        <div>
          <h2 className="text-2xl sm:text-3xl font-extrabold mb-2">Hello, Champion! 👋</h2>
        ...
        <div className="bg-white/10 backdrop-blur-md border border-white/20 px-5 py-3.5 rounded-2xl text-center self-start md:self-center">
      ...
      {loading ? (
        <div className="text-center py-20 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 rounded-3xl shadow-sm">
          <div className="w-10 h-10 border-4 border-indigo-600 border-t-transparent rounded-full animate-spin mx-auto mb-3"></div>
          <p className="text-slate-400 dark:text-slate-500 text-sm">Loading daily summaries from cloud...</p>
        </div>
      ) : (
        <>
          {/* Summary Stats Grid */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 rounded-3xl p-6 shadow-sm hover:shadow-md transition-all">
              <div className="flex items-center justify-between mb-4">
                <span className="p-3 bg-emerald-50 dark:bg-emerald-950/30 text-emerald-600 dark:text-emerald-400 rounded-2xl">
              ...
              <h3 className="text-slate-500 dark:text-slate-400 text-sm font-medium">Calories Consumed Today</h3>
              <p className="text-slate-900 dark:text-white text-3xl font-extrabold mt-1">
                {totalCalories.toLocaleString()} <span className="text-lg font-normal text-slate-400 dark:text-slate-500">/ {CALORIE_GOAL} kcal</span>
              </p>
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 rounded-3xl p-6 shadow-sm hover:shadow-md transition-all">
              <div className="flex items-center justify-between mb-4">
                <span className="p-3 bg-blue-50 dark:bg-blue-950/30 text-blue-600 dark:text-blue-400 rounded-2xl">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2.5" stroke="currentColor" className="w-6 h-6">
              ...
              <h3 className="text-slate-500 dark:text-slate-400 text-sm font-medium">Total Protein Today</h3>
              <p className="text-slate-900 dark:text-white text-3xl font-extrabold mt-1">
                {totalProtein} <span className="text-lg font-normal text-slate-400 dark:text-slate-500">/ {PROTEIN_GOAL} g</span>
              </p>
              <div className="mt-4 h-2 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 rounded-3xl p-6 shadow-sm hover:shadow-md transition-all">
              <div className="flex items-center justify-between mb-4">
                <span className="p-3 bg-violet-50 dark:bg-violet-950/30 text-violet-600 dark:text-violet-400 rounded-2xl">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2.5" stroke="currentColor" className="w-6 h-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 016.038 7.048 8.287 8.287 0 009 9.6a8.983 8.983 0 013.361-6.867 8.21 8.21 0 003 2.48z" />
                  </svg>
                </span>
                <span className={`text-xs font-semibold px-2.5 py-1 rounded-full ${totalWorkouts > 0 ? 'bg-emerald-50 dark:bg-emerald-950/30 text-emerald-600' : 'bg-amber-50 dark:bg-amber-950/30 text-amber-600 dark:text-amber-400'}`}>
                  {totalWorkouts > 0 ? 'Active Today' : 'Rest Day'}
                </span>
              </div>
              <h3 className="text-slate-500 dark:text-slate-400 text-sm font-medium">Workouts Logged Today</h3>
              <p className="text-slate-900 dark:text-white text-3xl font-extrabold mt-1">
                {totalWorkouts} <span className="text-lg font-normal text-slate-400 dark:text-slate-500">/{WORKOUT_GOAL} logged</span>
              </p>
              <div className="mt-4 h-2 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
          ...
          <div className="bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 rounded-3xl p-6 flex flex-col md:flex-row items-center justify-between gap-4 transition-colors">
            <div className="flex items-center gap-4">
              <span className="p-3 bg-white dark:bg-slate-800 rounded-2xl shadow-sm text-indigo-600 dark:text-indigo-400">
              ...
              <div>
                <h4 className="text-slate-900 dark:text-white font-semibold">Today's Health Status</h4>
